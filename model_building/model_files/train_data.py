...
pickle.dump(words, open('model_building/saved_models/words.pkl', 'wb'))
pickle.dump(classes, open('model_building/saved_models/classes.pkl', 'wb'))
...
model.save('model_building/saved_models/chatbot_model_v1.h5', history)
